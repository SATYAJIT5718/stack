...
import casio1 from '../../../assets/images/watches/casio.jpeg';
import casio2 from '../../../assets/images/watches/casio2.jpeg';
import casio3 from '../../../assets/images/watches/casio3.jpeg';
let Watches = () => {
  return (
    <>
        ...
        <div className="row">
          <div className="col-md-4 ">
            ...
            <h1 style={{color:'black'}}>OnePlus 8T</h1>
              <img src={casio1} alt="ImageOne" className='bg-dark' height='300px'/>
          ...
          <div className="col-md-4 ">
            ...
            <h1 style={{color:'black'}}>Casio EX188 Edifice</h1>
              <img src={casio3} alt="ImageOne" className='bg-dark' height='300px'/>
              <div className="card-body">
                <h4><b>Specification:</b></h4>
          ...
          <div className="col-md-4 ">
            <div className="card bg-danger justify-content-center">
            <h1 style={{color:'black'}}>ED436 Edifice</h1>
              <img src={casio2} alt="ImageOne" className='bg-dark' height='300px'/>
              <div className="card-body">
                <h4><b>Specification:</b></h4>
